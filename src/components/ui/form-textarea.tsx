      ...
      <div className="relative group">
        <textarea
          ...
          className={cn(
            ...
            "rounded-xl px-4 pt-6 pb-4 min-h-[120px] text-sm font-medium text-nri-navy dark:text-white",
            "placeholder-transparent outline-none transition-all duration-300 resize-none",
        ...
        <label
          htmlFor={id}
          className={cn(
            "absolute left-4 top-2 text-[10px] font-bold uppercase tracking-[0.15em] transition-all duration-300 cursor-text",
            ...
            "peer-focus:tracking-[0.15em] peer-focus:text-nri-orange dark:peer-focus:text-nri-orange"
          )}
        >
          {label}
        </label>
